...
from torch.nn import Module, ModuleList, Conv2d, Dropout2d, Sequential, ELU, ReLU, MaxPool2d, Linear, Flatten
...
class BiggerCNN(Module):
    ...
    def __init__(
        ...
        self.classifier = Linear(in_features=feature_extractor_output_size, out_features=num_classes)    
...
class DynamicCNN(Module):
    ...
    def __init__(
        ...
        self.layers = OrderedDict(
            self._make_layers(in_channels=in_channels, num_classes=num_classes, layer_configs=layer_configs)
        )
    ...
    def _make_layers(self, in_channels, num_classes, layer_configs) -> list:    
